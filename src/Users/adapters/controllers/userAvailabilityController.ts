...
export class UserAvailabilityController {
  ...
  async onCreateUserAvailability (req: Request, res: Response, next: NextFunction) {
    try {
  ...
  async onGetAllUserAvailabilities (req: Request, res: Response, next: NextFunction) {
    try {
  ...
  async onGetUserAvailabilityById (req: Request, res: Response, next: NextFunction) {
    try {
      const { id } = req.params
