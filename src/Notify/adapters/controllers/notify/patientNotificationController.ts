...
export class PatientNotificationController {
  ...
  async onCreatePatientNotification(req: Request, res: Response, next: NextFunction) {
    try {
      console.log(req.body);
      const newProfile = await this.interactor.createPatientNotification(req.body);
      res.json(newProfile);
      //   logger.info({
  ...
  async onGetAllPatientNotification(req: Request, res: Response, next: NextFunction) {
    try {
  ...
  async onGetPatientNotificationById(req: Request, res: Response, next: NextFunction) {
    try {
      const { id } = req.params;
