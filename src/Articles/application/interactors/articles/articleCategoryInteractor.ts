...
export class ArticleCategoryInteractor implements IArticleCategoryInteractor {
  ...
  async getArticleCategoryById(id: string): Promise<ArticlesCategoryEntity | null> {
    return await this.repository.findById(id);
  }

  async createArticleCategory(patientData: ArticlesCategoryEntity): Promise<ArticlesCategoryEntity> {
