...
const { addViralLoadTest, getAllViralLoad, getAllVlCategories, getViralLoadTest, editViralLoadTest, deleteViralLoadTest, getAllViralLoadByPatientID, calculateSuppression, vlCountTrend, getViralLoadTestByVisitID } = require('../controllers/viralLoad.controller');
...
router.get('/by-visit-id/:id', getViralLoadTestByVisitID);
