# Generated by Django 5.0.6 on 2024-11-17 17:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdAt', models.DateTimeField(auto_now_add=True)),
                ('updatedAt', models.DateTimeField(auto_now_add=True)),
                ('currentArtPrescriptionID', models.ForeignKey(db_column='artPrescriptionID', on_delete=django.db.models.deletion.CASCADE, to='linelist_api.artprescription')),
                ('patientID', models.ForeignKey(db_column='patientID', on_delete=django.db.models.deletion.CASCADE, to='linelist_api.patients')),
                ('enrolledBy', models.ForeignKey(db_column='userID', on_delete=django.db.models.deletion.CASCADE, to='linelist_api.user')),
                ('currentViralLoadID', models.ForeignKey(db_column='viralLoadID', on_delete=django.db.models.deletion.CASCADE, to='linelist_api.viralload')),
            ],
            options={
